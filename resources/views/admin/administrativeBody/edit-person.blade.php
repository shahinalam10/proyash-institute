                    ...
                    <div class="border p-4 rounded">
                        ...
                        <form action="{{route('update-person')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="Name" name="name" value="{{$administrativeperson->name}}" placeholder="Enter name">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="Designation" class="col-sm-3 col-form-label">Designation</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="Designation" name="designation" value="{{$administrativeperson->name}}" placeholder="Enter designation">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <img src="{{asset($administrativeperson->image)}}" alt="" style="height: 70px; width: 90px;">
                                </div>
                            </div>
