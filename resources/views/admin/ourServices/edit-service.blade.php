                ...
                <div class="card-body">
                    <div class="border p-4 rounded">
                        <div class="card-title d-flex align-items-center">
                            <h5 class="mb-0 text-dark">Edit services</h5>
                        </div>
                        <hr/>
                        <form action="{{ route('update-service') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="Title" name="title" value="{{ $proyashservice->title }}" placeholder="Enter news title">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="serviceContent" class="col-sm-3 col-form-label">service content</label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="serviceContent" name="service_content" rows="3"  placeholder="News Description">{{ $proyashservice->service_content }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <img src="{{ asset($proyashservice->image) }}" alt="" style="height: 70px; width: 90px">
                                </div>
                            </div>
