                ...
                <div class="card-body">
                    <div class="border p-4 rounded">
                        <div class="card-title d-flex align-items-center">
                            <h5 class="mb-0 text-dark">{{ session('message','Insert proyash news content and image') }}</h5>
                        </div>
                        <hr/>
                        <form action="{{route('new-proyash-news')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="news_Content" rows="3" name="news_content"  placeholder="News Description"></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
