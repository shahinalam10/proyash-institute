                    ...
                    <div class="border p-4 rounded">
                        ...
                        <form action="{{route('update-notice')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="News_title" name="title" value="{{$proyashnotice->title}}" placeholder="Enter notice title">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <img src="{{asset($proyashnotice->notice_file)}}" alt="" style="height: 70px; width:90px;">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="notice_date" class="col-sm-3 col-form-label">Published date</label>
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" id="notice_date" name="date" value="{{$proyashnotice->date}}">
                                </div>
                            </div>
                            <div class="row mb-3">
