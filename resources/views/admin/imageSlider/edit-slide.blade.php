                ...
                <div class="card-body">
                    <div class="border p-4 rounded">
                        <div class="card-title d-flex align-items-center">
                            <h5 class="mb-0 text-dark">{{session('message','Edit slider')}}</h5>
                        </div>
                        <hr/>
                        <form action="{{route('update-slide')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="Title" name="title" value="{{ $imageslider->title }}" placeholder="Enter news title">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="slide_Content" class="col-sm-3 col-form-label">Slide content</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="slide_Content" name="slide_content" value="{{ $imageslider->slide_content }}" placeholder="Content description">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <img src="{{ asset($imageslider->image) }}" alt="" style="height: 70px; width: 90px">
                                </div>
                            </div>
